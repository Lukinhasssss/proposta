...
class ControllerExceptionHandler {
    ...
    ): ResponseEntity<StandardErrorMessage> {
        val errorMessages =
            exception.bindingResult.fieldErrors.map { FieldError(it.field, it.defaultMessage.toString()) }.toSet()
        val errorResponse = StandardErrorMessage(
    ...
    fun handleAlreadyExistsException(
        ...
        request: HttpServletRequest
    ): ResponseEntity<AlreadyExistsExceptionMessage> {
        val fieldError = FieldError(exception.field, exception.message)
        val errorResponse = AlreadyExistsExceptionMessage(
    ...
    fun handleIntegrationErrorException(
        exception: IntegrationErrorException
    ): ResponseEntity<FieldError> {
